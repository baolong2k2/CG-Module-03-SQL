package com.example.multiverse_management.model.dto;
...
public class UserDto {
    ...
    public UserDto(Integer id, String email, String username, String password, String fullname,
                   String address, String phone, String avatar,  Integer roleId) {
        super();
        this.id = id;
        this.email = email;
    ...
    public UserDto(String email, String username, String password, String fullname, String address,
                   String phone, String avatar,  Integer roleId, String roleDesc) {
        super();
        this.email = email;
        this.username = username;
        this.password = password;
