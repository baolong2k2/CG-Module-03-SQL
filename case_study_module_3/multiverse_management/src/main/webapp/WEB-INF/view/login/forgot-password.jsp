...
<style>
    * {
    ...
    body {
        background-image: url("https://firebasestorage.googleapis.com/v0/b/multiverse-5e274.appspot.com/o/space-background.jpg?alt=media&token=e1b20730-4710-40ac-a2ba-a8a96c9322b5");
...
<div class="row">
    ...
    <div class="footer">
        ...
        <p class="information-text"><span class="symbols" title="Lots of love from me to YOU!">&hearts; </span><a href="https://www.facebook.com/" target="_blank" title="Connect with me on Facebook">Long The Conqueror</a></p>
    </div>
</div>
</body>
